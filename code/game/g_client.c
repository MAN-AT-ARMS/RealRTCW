...
//----(SA) added this for head separation
	...
	// Gothicstein - extra client info settings
...
void ClientSpawn( gentity_t *ent ) {
	...
	client->ps.sprintSpeedScale = 1.1;  // RealRTCW was 1.1
